...
public class HandleDatabase extends HttpServlet{
	private static final long serialVersionUID = -1486435701308196161L;
CachedRowSetImpl rowSet=null;
   ...
   public StringBuffer show(int page,int pageSize,CachedRowSetImpl rowSet){
      ...
      try{ 
           ...
           for(int i=1;i<=pageSize;i++){
              ...
              String s="<img src=image/public.jpg"+rowSet.getString(6)+" width=100 height=100/>";
              str.append("<td>"+s+"</td>"); 
              str.append("</tr>");
              rowSet.next();  
           }
   ...
   public  void  continueDoGet(HttpServletRequest request,HttpServletResponse response) 
      ...
      try{ con=DriverManager.getConnection(uri,"root","307188"); 
